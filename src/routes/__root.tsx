...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Safar-e-Haramain · Premium Umrah Packages 1447H" },
      { property: "og:description", content: "Premium Umrah packages from Pakistan — flights, visa, 5★ hotels near Haram & Roza-e-Rasool ﷺ, full ziyarat. Book your sacred journey." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "Safar-e-Haramain · Premium Umrah Packages 1447H" },
      { name: "twitter:description", content: "Premium Umrah packages from Pakistan — flights, visa, 5★ hotels near Haram & Roza-e-Rasool ﷺ, full ziyarat. Book your sacred journey." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/a34f92db-a15c-484e-a264-d890da100ad7/id-preview-015ccbd1--73e7eff3-ae19-44e0-9045-6c3195a6daa4.lovable.app-1780655564008.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/a34f92db-a15c-484e-a264-d890da100ad7/id-preview-015ccbd1--73e7eff3-ae19-44e0-9045-6c3195a6daa4.lovable.app-1780655564008.png" },
